...
class Attacker:
    ...
    def __init__(self, model_name: str, benign_dir: Optional[str] = None):
        ...
        self.model_dir = projects_dir["models_dir"] + "/" + model_name
        self.model = self.model_dir + "/" + model_name + ".model"
